...
const Page = () => {
  return (
    <div className=" min-h-dvh p-4">
      <div className="rounded-xl bg-white-smoke w-full pb-14 pt-24">
        <HeroSection
                  heading={
                    <>
                  ...
                  descriptionOne={
                    <span className="font-normal text-lg text-black leading-[160%]">
                      Insurance has modernized distribution, digitized applications, and accelerated decisioning models — but one critical dependency remains anchored in clinical reality:<span className="font-extrabold font-playfair italic text-[#109383] ">meaningful medical interpretation.</span>
                    </span>
                  }
                  descriptionTwo={
