...
//         alt="cta-image"
//         src={image}
//         className="md:absolute inset-e-0 bottom-0 z-10"
//       />
//     </div>
//   );
// };
...
type CTASectionProps = {
  ...
  primaryBtnBgClasses?: string;
  secondaryBtnBgClasses?: string;
...
const CTASection = ({
  title,
  highlightText,
  highlightTextClassName = "text-greenish-cyan font-playfair",
  description1,
  description2,
  primaryBtnLabel,
  secondaryBtnLabel,
        ...
        <div className="col-span-12 md:col-span-7 space-y-10">
              ...
              {highlightText
                ? title.split(highlightText).map((part, i, arr) => (
                    <span key={i}>
                      {part}
                      {i < arr.length - 1 && (
                        <span className={highlightTextClassName}>
                          {highlightText}
                        </span>
                      )}
                    </span>
          ...
          <div className="flex items-center flex-col md:flex-row gap-4">
            <ThemeButton
              ...
              bgClasses={
                primaryBtnVariant === "custom" ? primaryBtnBgClasses : undefined
              }
            />
